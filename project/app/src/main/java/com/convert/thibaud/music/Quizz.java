...
public class Quizz {
    ...
    String[][] myArrayNoobMusic = {{"Quelle est la chanson","2Law","Mercy","Butterflies And hurrican","Come as you are"},{"En quelle année est sorti cette chanson","1999","2001","2007","2005"},{"Quelle est la chanson","Ressistance","Isolated System","Hysteria","Madness"}};
    String[][] myArrayEzMusic = {{"Quelle est le nom de cette chanson","Origin of Symetry","Mercy","Drone","2Law"},{"Quelle est la chanson","Resistance","Algorithm","Absolution","Drones"},{"En quelle année est sorti l'album de cette chanson","1999","2001","2007","2005"}};
